...
import 'package:pcm_app/chemistry12/bookBLoC.dart';
import 'package:pcm_app/chemistry12/mypdf.dart';
...
class _bookState extends State<book> {
  List<Chemistrytwelveclass> _list = new List();

  _loadlist() async {
    _list = await getallchem12();
